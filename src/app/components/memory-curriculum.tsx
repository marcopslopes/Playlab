...
export function MemoryCurriculum() {
  ...
  const courses: Course[] = [
    {
      id: 'beginner',
      title: t('curriculum.memory.courses.beginner.title'),
      ageRange: t('curriculum.memory.courses.beginner.ageRange'),
      description: t('curriculum.memory.courses.beginner.description'),
      color: '#C08B7E',
      locked: false,
      progress: 0,
      emoji: '🧠',
      games: [
        { id: 'memory-pairs', title: t('curriculum.memory.games.memory-pairs.title'), type: t('curriculum.memory.games.memory-pairs.type'), completed: false, stars: 0, locked: false, emoji: '🐶' },
        { id: 'whats-missing', title: t('curriculum.memory.games.whats-missing.title'), type: t('curriculum.memory.games.whats-missing.type'), completed: false, stars: 0, locked: false, emoji: '❓' },
        { id: 'sequence-repeat', title: t('curriculum.memory.games.sequence-repeat.title'), type: t('curriculum.memory.games.sequence-repeat.type'), completed: false, stars: 0, locked: true, emoji: '🔁' },
      ],
    },
    {
      id: 'intermediate',
      title: t('curriculum.memory.courses.intermediate.title'),
      ageRange: t('curriculum.memory.courses.intermediate.ageRange'),
      description: t('curriculum.memory.courses.intermediate.description'),
      color: '#7D9D9C',
      locked: false,
      progress: 0,
      emoji: '⭐',
      games: [
        { id: 'grid-memory', title: t('curriculum.memory.games.grid-memory.title'), type: t('curriculum.memory.games.grid-memory.type'), completed: false, stars: 0, locked: false, emoji: '🎯' },
        { id: 'number-chain', title: t('curriculum.memory.games.number-chain.title'), type: t('curriculum.memory.games.number-chain.type'), completed: false, stars: 0, locked: true, emoji: '🔢' },
      ],
    },
  ];
